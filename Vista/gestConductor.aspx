...
<body>
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
            <label for="txtTipoLicencia">Tipo de licencia</label>
            <asp:TextBox ID="txtTipoLicencia" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
            <div class="form-group">
            ...
            <asp:TextBox ID="txtIdeTipoConductor" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
            <div class="form-row">
                <div class="col-8">
